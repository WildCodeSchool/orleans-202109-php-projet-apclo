...
<body>
    ...
    if (empty($errors)) {
        ...
        <p>Merci <?php echo $_POST["firstname"] . " "; ?><?php echo $_POST["lastname"] . " "; ?> 
        de nous avoir contacté à propos de <?php echo $_POST["subject"] . " "; ?>.

            Un des membres de l'APCLO vous contactera soit à l'adresse <?php echo $_POST['e-mail'] . " "; ?> 
            ou par téléphone au <?php echo $_POST["tel"] . " "; ?> dans les plus court délais, 
